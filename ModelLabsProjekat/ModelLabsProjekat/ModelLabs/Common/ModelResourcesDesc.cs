...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			typeIdsInInsertOrder.Add(ModelCode.RC);
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.RC_REGULATIONSCHEDULE);
            notSettablePropertyIds.Add(ModelCode.TAPCHANGER_TAPSCHEDULE);	
		}
